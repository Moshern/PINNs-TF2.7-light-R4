...
Note: pre-computed prediction outputs (`predict_results/`) are not included in this repository; they are regenerated by running `predict.py`, which produces prediction files on the z = 0, y = 2.4 and x = 1.7 planes.
